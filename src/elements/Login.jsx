...
function Login() {
    return (
        <>
        <div className="fullshadow" >a</div>
            <form className="form">
    ...
    <div className="flex-row">
      <button className="btn google">
        <svg xml:space="preserve"  viewBox="0 0 512 512" y="0px" x="0px" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Layer_1" width="20" version="1.1">
